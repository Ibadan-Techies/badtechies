      ...
      >
        <>
          ...
          <Backers
            title={
              <span>
                The leading tech community in Ibadan{' '}
                <span className="text-ibtc-blue">
                  run by renowned community experts
                </span>{' '}
                who have built exactly what we are doing.
              </span>
            }
          />
          <PrideComponent />
...
const GENERAL_DATA = {
  ...
  description:
    'Ibadan Techies is a non profit and playground for tech talents in Africa.',
  sameAs: [
  ...
  keywords:
    'Ibadan tech, top nonprofit organization in Africa, techmeetups in Africa, tech meetups in Nigeria, meetups in Ibadan, besttech community in Nigeria, top tech community in Africa',
  founder: 'Kelvinsekx',
