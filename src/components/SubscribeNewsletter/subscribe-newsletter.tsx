...
function SubscribeNewsLetter() {
  return (
    <div className="_body bg-ibtc-light-yellow  relative">
      <div className="_wrapper flex flex-col items-center justify-center min-h-[26rem] gap-[4rem]">
        ...
        <div className="w-full items-center mx-auto flex flex-col lg:flex-row justify-center px-4 gap-[1.15rem] max-w-[400px] lg:max-w-full">
          <input
            type="email"
            name="your-email"
